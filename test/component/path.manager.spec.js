...
describe("PathManager", function () {
  ...
  it.skip("Moving creep to target in same path", function () {
    let pathManager = new PathManager("test");
    let creep = {
      name : "testCreep",
  ...
  it.skip("Moving creep to target in next path", function () {
    let pathManager = new PathManager("test");
    let creep = {
      name : "testCreep",
      move : sandbox.stub().returns(OK),
  ...
  it.skip("Moving creep to target 2 paths out", function () {
    let pathManager = new PathManager("test");
    let creep = {
      name : "testCreep",
      move : sandbox.stub().returns(OK),
  ...
  describe.skip("Moving creep with other creeps on the same path", function () {
    let pathManager;
  ...
  describe.skip("Moving creep with other creeps on the different paths", function () {
  ...
  describe("traverseToTarget", function () {
    let pathManager, move;
    ...
    it("test", function () {
      let traversal = pathManager.traverseToTarget({
        pathIdx: 0,
        pathPos: 0
      }, {
        pathIdx: 1,
      ...
      should([...traversal]).be.eql(
        [
          { idx: 0,
            pos: 1,
            point: { x: 6, y: 6, dx: 1, dy: 1, direction: 4 },
            remaining: 11 },
          { idx: 0,
            pos: 2,
            point: { x: 7, y: 7, dx: 1, dy: 1, direction: 4 },
            remaining: 10 },
          { idx: 0,
            pos: 3,
            point: { x: 8, y: 8, dx: 1, dy: 1, direction: 4 },
            remaining: 9 },
          { idx: 0,
            pos: 4,
            point: { x: 9, y: 9, dx: 1, dy: 1, direction: 4 },
            remaining: 8 },
          { idx: 0,
            pos: 5,
            point: { x: 10, y: 10, dx: 1, dy: 1, direction: 4 },
            remaining: 7 },
          { idx: 0,
            pos: 6,
            point: { x: 11, y: 11, dx: 1, dy: 1, direction: 4 },
            remaining: 6 },
          { idx: 0,
            pos: 7,
            point: { x: 12, y: 12, dx: 1, dy: 1, direction: 4 },
            remaining: 5 },
          { idx: 0,
            pos: 8,
            point: { x: 13, y: 12, dx: 1, dy: 0, direction: 3 },
            remaining: 4 },
          { idx: 0,
            pos: 9,
            point: { x: 14, y: 12, dx: 1, dy: 0, direction: 3 },
            remaining: 3 },
          { idx: 0,
            pos: 10,
            point: { x: 15, y: 12, dx: 1, dy: 0, direction: 3 },
            remaining: 2 },
          { idx: 0,
            pos: 11,
            point: { x: 16, y: 12, dx: 1, dy: 0, direction: 3 },
            remaining: 1 },
          { idx: 0,
            pos: 12,
            point: { x: 17, y: 12, dx: 1, dy: 0, direction: 3 },
            remaining: 0 },
          { idx: 1,
            pos: 6,
            point: { x: 18, y: 12, dx: -1, dy: 1, direction: 6 },
            remaining: 5 },
          { idx: 1,
            pos: 5,
            point: { x: 19, y: 11, dx: -1, dy: 1, direction: 6 },
            remaining: 4 },
          { idx: 1,
            pos: 4,
            point: { x: 20, y: 10, dx: -1, dy: 1, direction: 6 },
            remaining: 3 },
          { idx: 1,
            pos: 3,
            point: { x: 21, y: 9, dx: -1, dy: 0, direction: 7 },
            remaining: 2 },
          { idx: 1,
            pos: 2,
            point: { x: 22, y: 9, dx: -1, dy: 0, direction: 7 },
            remaining: 1 },
          { idx: 1,
            pos: 1,
            point: { x: 23, y: 9, dx: -1, dy: 0, direction: 7 },
            remaining: 0 }
        ]
      );
    });
