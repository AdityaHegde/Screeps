/* globals Game, LOOK_STRUCTURES, STRUCTURE_RAMPART, ERR_NOT_IN_RANGE */
...
module.exports = BaseTask.extend({
    getTargets: function () {
        if (this.room.defence.enemyArmy) {
            return this.room.lookForAtArea(LOOK_STRUCTURES,
                this.room.defence.enemyArmy.area.top, this.room.defence.enemyArmy.area.left,
    ...
    isTaskValid: function (creep, target) {
        let nearestRampart = creep.task.nearestRampart && Game.getObjectById(creep.task.nearestRampart);
